	...
	<div class="sns-top">
		<ol>
			...
			<?php if( function_exists('scc_get_share_twitter') && ! empty( scc_get_share_twitter() ) ): ?>
				<li class="twitter"><a href="https://twitter.com/intent/tweet?url=<?php echo $url_encode ?>&text=<?php echo $title_encode ?>&via=<?php echo get_the_tw_code(); ?>&tw_p=tweetbutton"><i class="jic jin-ifont-twitter"></i><span>&nbsp;<?php if(function_exists('scc_get_share_twitter')) echo (scc_get_share_twitter()==0)?'':scc_get_share_twitter(); ?></span></a>
				</li>
			<?php else: ?>
				<li class="twitter"><a href="https://twitter.com/intent/tweet?url=<?php echo $url_encode ?>&text=<?php echo $title_encode ?>&via=<?php echo get_the_tw_code(); ?>&tw_p=tweetbutton"><i class="jic jin-ifont-twitter"></i></a>
				</li>
			<?php endif; ?>
			<!--Facebookボタン-->
