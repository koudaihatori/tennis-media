	...
	<?php if ( is_mobile() ) : ?>
		<?php if( get_the_top_image_url_sp() ): ?>
			...
			<?php if( ! empty(get_theme_mod( 'top_image_link' ))): ?>
				<a href="<?php echo get_theme_mod( 'top_image_link' ); ?>" class="jin-sp-design"><img src="<?php echo get_the_top_image_url_sp(); ?>" class="jin-sp-design" /></a>
			<?php else: ?>
		...
		<?php else: ?>
			...
			<?php else: ?>
				<img src="<?php echo get_the_top_image_url(); ?>" class="jin-sp-design" />
			<?php endif; ?>
