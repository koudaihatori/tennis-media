...
//管理画面に公式アイコンリストページへのリンク掲載
function jin_icon_page_link() {
	add_menu_page('JINアイコン一覧', 'JINアイコン一覧', 'manage_options', 'jiniconlist','','dashicons-archive',23);
}
add_action('admin_menu', 'jin_icon_page_link');

function admin_icon_link() {
?>
<script async>
jQuery(function($){
	var slug = 'jiniconlist';
	$('a.toplevel_page_' + slug).prop({
		// 外部URL
...
add_action('admin_print_footer_scripts', 'admin_icon_link');