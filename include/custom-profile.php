...
<div class="profile-card">
	...
	<div class="profile-link-box">
		...
		<div class="profile-link ef"><span><i class="jic jic-type jin-ifont-arrow-circle"></i>BLOG LINK：</span><a href="<?php the_author_meta( 'user_url' ); ?>" target="_blank"><?php the_author_meta( 'user_url' ); ?></a></div>
		<?php endif; ?>
