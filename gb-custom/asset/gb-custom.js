	...
	bl(
		'jin-gb-block/box', {
			...
			icon: function(){
				return el(
					'img',
					{src:jin_inst_dir+'/img/notitle-box-icon.png'}
				);
			},
			category: 'jin-block',
	...
	bl(
		'jin-gb-block/box-with-headline', {
			...
			icon: function(){
				return el(
					'img',
					{src:jin_inst_dir+'/img/box-icon.png'}
				);
			},
			category: 'jin-block',
	...
	bl(
		'jin-gb-block/icon-box', {
			...
			icon: function(){
				return el(
					'img',
					{src:jin_inst_dir+'/img/icon-box-icon.png'}
				);
			},
			category: 'jin-block',
	...
	bl(
		'jin-gb-block/simple-button', {
			...
			icon: function(){
				return el(
					'img',
					{src:jin_inst_dir+'/img/button-icon.png'}
				);
			},
			category: 'jin-block',
						...
						el(
							...
							el(
								wp.components.RadioControl,{
									label:'リンク先を別タブで開く',
									options:buttonTargetList,
									selected:props.attributes.buttonTarget,
									value:props.attributes.buttonTarget,
									onChange: function (changedContent) {props.setAttributes({ buttonTarget: changedContent });}
								}
							)
						),
	...
	bl(
		'jin-gb-block/rich-button', {
			...
			icon: function(){
				return el(
					'img',
					{src:jin_inst_dir+'/img/button-rich-icon.png'}
				);
			},
			category: 'jin-block',
