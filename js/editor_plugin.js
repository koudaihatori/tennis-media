					...
					menu: [
						...
						text: 'アイコン',
							menu: [
								...
								text: 'ペン',
									onclick: function() {
										ed.insertContent('[jin_icon_pen color="#e9546b" size="18px"]');
									}
								},{
								text: 'チェック',
									onclick: function() {
								...
								text: 'チェック（丸）',
									onclick: function() {
										ed.insertContent('[jin_icon_check_circle color="#e9546b" size="18px"]');
									}
								},{
								text: 'メール',
									onclick: function() {
								...
								text: 'インフォメーション',
									onclick: function() {
										ed.insertContent('[jin_icon_info color="#e9546b" size="18px"]');
									}
								},{
								text: 'フォルダ',
									onclick: function() {
